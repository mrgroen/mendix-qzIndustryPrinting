...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("qzIndustryPrinting.SigningKey", mendixObject.getType()))
			return qzindustryprinting.proxies.SigningKey.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("qzIndustryPrinting.SiteCertificate", mendixObject.getType()))
